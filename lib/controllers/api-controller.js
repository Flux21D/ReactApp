...
var injectContent = function injectContent(res, type, temp, popularity, userFav, userReg, options, search, isHome, page, start, end) {
    push.modifyCourseData(type, temp, popularity, userFav, userReg, options, search, isHome, function (courseBox) {
        ...
        temp.page = page;
        if (type === 'course') contenthelp.getPage(slugs.slugs['Cursos'].id, function (data, error) {
