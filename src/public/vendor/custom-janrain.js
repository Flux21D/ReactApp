...
/*window.onload = function() {
	var btnid = document.getElementById('login-btn');
	...
	document.getElementsByClassName('forgotpwd-link').addEventListener('click', function(){		
		divClasses1.remove("show");
		divClasses2.remove("show");
	}, false);
};*/
...
/*$(document).ready(function() {
   $(document).ready(function() {
			$('#login-btn').click(function(){		
				$('#signIn, #login-overlay').addClass('show');
			});
			
			$('#close-btn').click(function(){		
				$('#signIn, #login-overlay').removeClass('show');
			});
			
			$('.forgotpwd-link').click(function(){
				$('#signIn, #login-overlay').removeClass('show');
			});
